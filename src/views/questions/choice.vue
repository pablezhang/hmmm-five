  ...
  <div>
    <el-card class="box-card" style="margin:20px">
      <el-row type="flex">
        ...
        <el-col :span="2">
          <el-button type="danger" size="small" @click="$router.push('/questions/new')"> <i class="el-icon-edit" />新增试题</el-button>
        </el-col>
      </el-row>
      <div class="item">
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="学科">
                <el-select v-model="fromData.subjectID" @change="changeSubjectID">
            ...
            <el-col :span="6">
              <el-form-item label="关键字">
                <el-input placeholder="请输入关键字" style="width:202px" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-row type="flex" justify="end">
                ...
                <el-button size="small" type="primary">搜素</el-button>
              </el-row>
            </el-col>
          </el-row>
        </el-form>
          ...
          <el-tab-pane v-for="item in changeList" :key="item" :label="item">
            ...
            <el-table style="margin-top:20px" :data="tableData">
              ...
              <el-table-column prop="addDate" label="录入时间" width="160px">
                <template #default="{row}">
                  <span>{{ new Date(row.addDate).toLocaleString('zh-CN', { timeZone: 'Asia/Shanghai' }).replace(/\//g, '-') }}</span>
                </template>
              </el-table-column>
    ...
    <el-dialog title="题目预览" :visible.sync="oneDia" style="font-size:14px">
      <el-row type="flex">
        <el-col :span="6">
          <span>【题型】：{{ oneDiaList.questionType==='1'?'单选':'多选' }}</span>
        </el-col>
        <el-col :span="6">
      ...
      <el-radio-group :value="isRight">
        <el-row v-for="item in oneDiaList.options " :key="item.id" style="margin-top:20px">
          <el-radio :label="item.isRight">{{ item.title }}</el-radio>
        </el-row>
      </el-radio-group>
      <hr>
      <el-row>
        <span>【参考答案】：<el-button type="danger" size="small">视频答案预览</el-button></span>
      </el-row>
      <hr>
      ...
      <el-row type="flex" style="margin-top:20px" justify="end">
        <el-col :span="2">
          <el-button type="primary" size="small" @click="oneDiaList=false">关闭</el-button>
        </el-col>
      </el-row>
    </el-dialog>
...
export default {
  data() {
    return {
      ...
      total: 1,
      params: { page: 1, pagesize: 10, questionType: '' },
      tableData: [],
      selectList: [],
      directoryList: [],
      tagsList: [],
      questionList: [{ label: '单选', value: 1 }, { label: '多选', value: 2 }, { label: '简答', value: 3 }],
      difficultyList: [{ label: '简单', value: 1 }, { label: '一般', value: 2 }, { label: '困难', value: 3 }],
      directionList: [{ label: '外包服务', value: 1 }, { label: '企业服务', value: 2 }, { label: '互联网金融', value: 3 }, { label: '企业咨询', value: 4 }, { label: '互联网', value: 5 }, { label: '电子商务', value: 6 }, { label: '其他', value: 7 }],
      userList: [],
      oneDia: false,
      isRight: 1,
      oneDiaList: {},
